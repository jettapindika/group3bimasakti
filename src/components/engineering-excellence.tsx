            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{
                    y: isHovered ? -8 : 0,
                    borderColor: isHovered ? "rgba(255, 140, 66, 0.5)" : "rgba(255, 140, 66, 0.25)",
                  }}
                  transition={{ 
                    type: "spring",
                    stiffness: 300,
                  ...
                  style={{
                    boxShadow: isHovered ? "0 20px 40px rgba(255, 140, 66, 0.15)" : "0 0 0 rgba(255, 140, 66, 0)"
                  }}
                >
                  {/* Icon */}
                  <motion.div
                  ...
                  <motion.h3 
                    ...
                    animate={{ 
                      color: isHovered ? "rgb(255, 140, 66)" : "rgb(255, 255, 255)"
                    }}
