...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-foreground overflow-hidden relative scroll-smooth">
      ...
      >
        ...
        >
          ...
          <div className="space-y-8">
            ...
            >
              Bimasakti Racing Team pushes boundaries with cutting-edge
              aerodynamics, precision engineering, and relentless innovation.
              From design to dominance, we engineer victory.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <MagneticButton
                  ...
                  onClick={() => {
                    document.getElementById("engineering")?.scrollIntoView({
                      behavior: "smooth",
                    });
                  }}
                >
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    dragElastic={0.3}
                    onClick={() =>
                      setSelectedStat(selectedStat === i ? null : i)
                    }
                  ...
                  >
                    ...
                    <motion.div
                      animate={
                        selectedStat === i ? { rotate: 360 } : { rotate: 0 }
                      }
                    ...
                    <motion.p
                      ...
                      animate={
                        selectedStat === i ? { scale: 1.1 } : { scale: 1 }
                      }
                    >
                      {stat.label}
                    </motion.p>
            ...
            {[
              {
                ...
                desc: "Achieved first place in Business Plan Presentation, showcasing our strategic vision and comprehensive business model.",
              },
              {
                year: "2nd",
                title: "Cost and Manufacturing",
                desc: "Secured second place in Cost and Manufacturing, demonstrating our efficiency in production planning and cost optimization.",
              },
              {
                year: "3rd",
                title: "Engineering Design Presentation",
                desc: "Earned third place in Engineering Design Presentation, highlighting our innovative technical solutions and design excellence.",
              },
              {
                year: "2nd",
                title: "Best Overall Class 3",
                desc: "Achieved second place in Overall Class 3, reflecting our team's comprehensive performance across all competition categories.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.year}
      ...
      <section
        id="engineering"
        className="relative py-24 md:py-40 px-4 md:px-8"
      >
        <EngineeringExcellence />
      </section>
      {/* Scroll Cards Section */}
      <section className="relative py-24 md:py-40 px-4 md:px-8 bg-gradient-to-b from-black via-secondary/5 to-black">
        <ScrollCards />
      </section>
      {/* Specs Section */}
      <section
        id="specs"
        className="relative py-24 md:py-40 px-4 md:px-8 bg-gradient-to-b from-secondary/3 to-background"
      >
        <SpecsSection />
      </section>
      ...
      >
        ...
        >
          ...
          <MagneticButton
            ...
            onClick={() => {
              window.open("https://instagram.com/grandlaunchingbm_3", "_blank");
            }}
          >
            Get in Touch
          </MagneticButton>
